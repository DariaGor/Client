...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox1->Size = System::Drawing::Size(504, 69);
			this->richTextBox1->TabIndex = 1;
			this->richTextBox1->Text = L"";
			// 
			// richTextBox2
			// 
			this->richTextBox2->Location = System::Drawing::Point(12, 55);
			this->richTextBox2->Name = L"richTextBox2";
			this->richTextBox2->ReadOnly = true;
			this->richTextBox2->ScrollBars = System::Windows::Forms::RichTextBoxScrollBars::Vertical;
			this->richTextBox2->Size = System::Drawing::Size(504, 290);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(524, 384);
			...
			// richTextBox3
			// 
			this->richTextBox3->Location = System::Drawing::Point(528, 131);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(542, 253);
			...
			this->label2->Location = System::Drawing::Point(528, 112);
			...
			// richTextBox4
			// 
			this->richTextBox4->Location = System::Drawing::Point(528, 173);
			...
			this->label5->Location = System::Drawing::Point(528, 157);
			...
			// richTextBox5
			// 
			this->richTextBox5->Location = System::Drawing::Point(528, 224);
			...
			this->label6->Location = System::Drawing::Point(520, 208);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(125, 13);
			this->label6->TabIndex = 12;
			this->label6->Text = L"Введите доменное имя";
			...
			this->ClientSize = System::Drawing::Size(667, 455);
